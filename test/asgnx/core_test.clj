...
(deftest handle-message-test
  (testing "the integration and handling of messages"
    (let [ehdlrs (merge
      ...
      (is (= "Rand is now a campus dining option."
             (<!! (handle-message
                   system
                   "darius"
                   "add-dining Rand"))))
      (is (= "Hours for Rand have been updated."
             (<!! (handle-message
                   system
                   "darius"
                   "edit-hours Rand Monday 7am-3pm"))))
      (is (= "Working..."
             (<!! (handle-message
                   system
                   "+14044847193"
                   "hours Rand Monday"))))
      (is (= "mac is now a menu item for Rand on Monday"
             (<!! (handle-message
                   system
                   "darius"
                   "add-item Rand Monday mac side"))))
      (is (= "randwich is now a menu item for Rand on Monday"
             (<!! (handle-message
                   system
                   "darius"
                   "add-item Rand Monday randwich entree"))))
      (is (= "Looking for menu..."
             (<!! (handle-message
                   system
                   "darius"
